...
class FrameEvent07 extends Frame{
	...
	public FrameEvent07() {
		setTitle("Frame Window Color Change");
		...
		//이벤트 핸들러 객체 생성
		ButtonListener07 handler = new ButtonListener07(this);//this 프레임 윈도우 내 자신
...
class ButtonListener07 implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Red")) {//버튼위의 캡션 문자열 내용만 같다면 참. 객체주소는 비교 안한다.
